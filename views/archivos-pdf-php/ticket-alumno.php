<?php
    ...
    $query = "SELECT * 
    FROM alumno_curso INNER JOIN alumno ON alumno_curso.id_alumno = alumno.id_alumno
    INNER JOIN cursos ON alumno_curso.id_curso = cursos.id_curso 
    WHERE alumno_curso.id_alumno_curso = '$cra';";
...
<body>
    <div class="container-info-pdf">
        ...
        <div class="info-ticket">
            <p>ID de compra: <?= $compra['id_alumno_curso'] ?></p>

            <div class="separator"></div>

            <h3>Datos del alumno</h3>

            <p>ID de alumno: <?= $compra['id_alumno'] ?></p>

            <p>Nombre: 
                <?= $compra['nombre_alumno']." ".$compra['segundo_nombreAlumno']." ".$compra['apellido_paternoAlumno']." ".$compra['apellido_maternoAlumno'] ?>
            </p>

            <p>Correo: <?= $compra['email_alumno'] ?></p>

            <p>Teléfono: <?= $compra['numero_tel_Alumno'] ?></p>

            <div class="separator"></div>

            <p>Fecha de compra: <?= $compra['f_creacion_al_cur'] ?></p>
