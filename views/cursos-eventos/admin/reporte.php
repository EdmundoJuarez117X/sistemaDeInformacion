...
<!DOCTYPE html>
    <html lang="en">        
        ...
        <body>
                        ...
                        <div class="sales-form">
                            ...
                            <div>
                                ...
                                <div class="fields-middle second-middle">
                                    <button class="btn-action-see" id="btn-see-info" onclick="mostrar_datos()">VER</button> 
                                </div>
                            </div>
                            <div id="show-inputs-data-filter"></div>
                            <!-- INFORMACION DE CURSOS -->
                            <div id="report-courses-info"></div>
                            <!-- FIN -->
                        </div>
                    </div>
                </main>
            ...
            <!--<script type="text/javascript" src="../../../js/cursos-eventos/show-info-courses.js"></script>-->
            <script src="../../../js/cursos-eventos/mostrar-datos.js"></script>
            <script src="../../../js/cursos-eventos/descargar-reporte.js"></script>
        </body>
    </html>