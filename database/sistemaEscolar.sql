...
CREATE TABLE IF NOT EXISTS `docente` (
    ...
    `f_modificaicon_Docente` datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `alumno` (
    ...
    `f_modificaicon_Alumno` datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `aspirante` (
    ...
    `f_modificaicon_Aspirante` datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `master` (
    ...
    `f_modificaicon_Master` datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `administrador` (
    ...
    `subMatAdm` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'MST' NOT NULL,
    ...
    `f_modificaicon_Admin` datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `padreDeFamilia` (
    ...
    `f_modificaicon_padreDeFam` datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `padreDeFamiliaHijo`(
    ...
    FOREIGN KEY(`id_padreDeFamilia`) REFERENCES `padreDeFamilia`(`id_padreDeFamilia`),
    FOREIGN KEY(`id_aspirante`) REFERENCES `aspirante`(`id_aspirante`),
    FOREIGN KEY(`id_alumno`) REFERENCES `alumno`(`id_alumno`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
