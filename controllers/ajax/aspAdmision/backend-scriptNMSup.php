...
//  $escuela = $_POST['escuela'];
 ...
 $modalidadE = $_POST['modalidadE'];
  ...
  WHERE escuela_nivelEducativo.nombre_nivelEducativo = '$nivelEdu' AND escuela_modalidadEscolar.nombre_modalidad = '$modalidadE' AND escuela_pago.descripcion LIKE 'Exámen de Admisión%'";
