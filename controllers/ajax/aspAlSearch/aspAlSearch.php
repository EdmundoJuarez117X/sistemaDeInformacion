...
// echo $search;
    ...
    function fetch_data()
    {
        ...
        WHERE aspirante.email_aspirante LIKE '$search%' AND aspirante.estatus_Aspirante != 'INSCRITO' AND aspirante.estatus_Aspirante != 'BAJA' AND aspirante.estatus_Aspirante !='RENOVAR'";
    ...
    function show_data($fetchData)
    {
        ...
        if (count($fetchData) > 0) {
            ...
            foreach ($fetchData as $data) {
                ...
                echo "<tr>
          <td>" . $data['nombre_aspirante'] . " " . $data['segundo_nombreAspirante'] . "</td>
